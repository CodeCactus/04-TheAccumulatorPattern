...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_oracle = math.factorial(72)
    answer_from_my_code = factorial(72)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 5
    answer = count_cosines_from(13, 19, -0.41)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 3
    answer = count_cosines_from(74, 82, 0.8)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(22, 23, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 47
    answer = count_cosines_from(12, 90, -0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 95
    answer = count_cosines_from(69, 420, 0.666)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.397  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(62, 91)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.182  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(12, 37)
